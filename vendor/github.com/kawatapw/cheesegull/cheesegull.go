...
import (
	...
	"github.com/kawatapw/cheesegull/api"
	"github.com/kawatapw/cheesegull/dbmirror"
	"github.com/kawatapw/cheesegull/downloader"
	"github.com/kawatapw/cheesegull/housekeeper"
	"github.com/kawatapw/cheesegull/models"

	// Components of the API we want to use
	_ "github.com/kawatapw/cheesegull/api/download"
	_ "github.com/kawatapw/cheesegull/api/metadata"
)
